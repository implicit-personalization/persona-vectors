...
OUT_ROOT="${OUT_ROOT:-artifacts/experiments/projected_vector_rerun/$(date -u +%Y%m%dT%H%M%SZ)__google__gemma-2-9b-it__${VECTOR_TRANSFORM}__layers_${LAYERS_LABEL}__q20}"
